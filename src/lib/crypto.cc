	...
	try {
		...
		static const sTestSample Samples[] = {
			...
			{ &SHA256, string(
					...
					"\x26\xe8\x3b\x2a\xc5\xb9\xe2\x9e"
					"\x1b\x16\x1e\x5c\x1f\xa7\x42\x5e"
					"\x73\x04\x33\x62\x93\x8b\x98\x24", 32 ), string(
			...
			{ &SHA256, string(
					...
					"\xd6\x88\x65\xc8\x20\x61\xd5\xe2"
					"\x54\x52\xb5\x5b\x52\x17\x98\xb1"
					"\x11\x50\x85\x96\x2e\x49\xe8\xfd"
					"\xda\xb7\xf4\xfb\xa3\x9c\xd8\x2c", 32) },
			{ &SHA256, string(
					"\xd6\x88\x65\xc8\x20\x61\xd5\xe2"
					"\x54\x52\xb5\x5b\x52\x17\x98\xb1"
					"\x11\x50\x85\x96\x2e\x49\xe8\xfd"
					"\xda\xb7\xf4\xfb\xa3\x9c\xd8\x2c", 32), string(
					"\x7f\x85\x39\xc2"
					, 32 ) },
			{ NULL, string(), string() }
		};
