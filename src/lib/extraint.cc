...
//
// Function:	TGenericBigInteger :: bitXOR
// Description:
//
template <typename tLittleInteger>
void TGenericBigInteger<tLittleInteger>::bitXOR(const TGenericBigInteger &a, const TGenericBigInteger &b)
{
	typename tLittleDigitsVector::const_iterator itA;
	typename tLittleDigitsVector::const_iterator itB;

	TGEN_BIG_INT_SELF_CHECK( this == &a || this == &b, bitXOR(a,b) );
